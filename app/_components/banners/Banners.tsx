...
const Banners = async () => {
    ...
    const response = await fetchData(`https://pixabay.com/api/?key=${process.env.PIXABAY_API_KEY}&q=texture&image_type=photo&orientation=horizontal&page=4&per_page=4`)
